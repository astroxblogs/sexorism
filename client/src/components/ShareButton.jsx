...
const ShareButton = ({
  ...
  const links = useMemo(
    () => [
      ...
      { name: "Instagram", href: `https://www.instagram.com/?url=${encodedUrl}`, Icon: InstagramIcon },
  ...
  return (
    <div className="relative inline-block" ref={dropdownRef}>
      <button
        ...
        className={
          variant === "icon"
            ? "flex items-center gap-1.5 rounded-md p-1.5 hover:bg-gray-100 dark:hover:bg-gray-700"
            : primary
        ...
        {variant === "icon" ? (
          <>
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-3.5 h-3.5 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white"
            >
            ...
            {showCountOnIcon && (
              <span className="text-[10px] text-gray-700 dark:text-gray-200 ml-0.5">
                {shareCount}
              </span>
            )}
          </>
            ...
            {links.map(({ name, href, Icon }) => (
              <li key={name}>
                <a
                  ...
                  className="flex items-center gap-3 px-3 py-2 rounded-lg text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-700"
                  onClick={async () => {
                    setOpen(false);
                    await incrementShareCount(blogId);
