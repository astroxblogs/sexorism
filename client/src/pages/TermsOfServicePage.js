  ...
  const sections = [
    {
      icon: '📜',
      title: 'Introduction',
      content: 'Welcome to Innvibs.com. By accessing or using our website, you agree to comply with and be bound by the following Terms of Service. If you do not agree with these terms, please refrain from using our site.'
    },
    {
      icon: '⚖️',
    ...
    },
    {
      ...
      content: 'All content on Innvibs.com, including text, images, and logos, is protected by copyright and trademark laws. You may not use, reproduce, or distribute any content without our prior written permission.'
    },
    {
      icon: '👤',
      title: 'User Conduct',
    ...
    },
    {
      ...
      content: 'If you contribute content to our website, such as comments or articles, you grant Innvibs.com a non-exclusive, royalty-free license to use, modify, and display your content.'
    },
    {
      icon: '⚠️',
      title: 'Limitation of Liability',
      content: 'Innvibs.com is not liable for any damages arising from the use or inability to use our website. This includes, but is not limited to, direct, indirect, incidental, or consequential damages.'
    },
    {
      icon: '🏛️',
      title: 'Governing Law',
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-amber-800 dark:text-amber-200 leading-relaxed">
                By continuing to use Innvibs.com, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. Your continued use of the website constitutes acceptance of any modifications to these terms.
              </p>
            </div>
          </div>
        </div>
