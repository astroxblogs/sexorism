...
import { slugify } from "../../utils/Public-utils/slugify";
...
const SearchResultsPage = () => {
  ...
  const getSnippet = (htmlContent, maxLength = 200) => {
        ...
        {!loading && !error && blogs.length === 0 && query && (
          <div className="flex flex-col items-center justify-center py-20 space-y-8">
            <div className="relative">
              ...
              <div className="absolute -inset-4 bg-gradient-to-r from-gray-200/50 to-gray-300/50 dark:from-gray-700/50 dark:to-gray-600/50 rounded-full blur-xl animate-pulse"></div>
            </div>
