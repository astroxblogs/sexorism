...
const HomePage = () => {
    ...
    useEffect(() => {
        const fetchFeaturedBlogs = async () => {
            ...
            try {
                ...
                if (blogContext?.setFeaturedBlogs) {
                    blogContext.setFeaturedBlogs(res.data);
                }
            } catch (err) {
    ...
    }, [activeCategory, searchQuery]); // Remove sidebarSections.length to prevent infinite loops
