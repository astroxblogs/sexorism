...
const AdminLogin = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // --- FIX: Corrected the navigation paths ---
            // This now checks the user's role and navigates to the full, correct
            // route for each dashboard.
            ...
            if (resolvedRole === 'operator') {
                ...
                // Fallback in case role is not defined
                navigate('/');
            }
