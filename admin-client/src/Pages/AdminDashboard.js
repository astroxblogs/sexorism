        ...
        switch (activeView) {
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border">
                            ...
                            <p className="text-gray-600">
                                Select an option from the sidebar to get started. You can create new blog posts, 
                                manage existing content, and handle administrative tasks.
                            </p>
                        </div>
                    </div>
                );
            ...
            case 'blogList':
                return (
                    <div className="bg-white rounded-xl shadow-sm border">
                        <div className="p-6 border-b">
                            <h2 className="text-2xl font-semibold text-gray-800">{t('Manage Blogs')}</h2>
                        </div>
                        <div className="p-6">
                            <AdminBlogList onEdit={(blog) => { setEditingBlog(blog); handleViewChange('blogForm'); }} />
                        </div>
                    </div>
                );
            case 'categoryManager':
                return (
                    <div className="bg-white rounded-xl shadow-sm border">
                        <div className="p-6 border-b">
                            <h2 className="text-2xl font-semibold text-gray-800">{t('Category Management')}</h2>
                        </div>
                        <div className="p-6">
                            <CategoryManager />
                        </div>
            ...
            case 'pendingApprovals':
                return (
                    <div className="bg-white rounded-xl shadow-sm border">
                        <div className="p-6 border-b">
                            <h2 className="text-2xl font-semibold text-gray-800">{t('Pending Approvals')}</h2>
                        </div>
                        <div className="p-6">
            ...
            case 'operatorManagement':
                return (
                    <div className="bg-white rounded-xl shadow-sm border">
                        <div className="p-6 border-b">
                            <h2 className="text-2xl font-semibold text-gray-800">{t('Operator Management')}</h2>
                        </div>
                        <div className="p-6">
                            <OperatorManagement />
                        </div>
            ...
            case 'adminSettings':
                return (
                    <div className="bg-white rounded-xl shadow-sm border">
                        <div className="p-6 border-b">
                            <h2 className="text-2xl font-semibold text-gray-800">{t('Admin Settings')}</h2>
                        </div>
                        <div className="p-6">
                            <AdminSetting />
                        </div>
